...
# Classe Master
class Master:
    def __init__(self, port_tcp=8080, db_host="localhost", db_user="root", db_password="toto", db_database="Routagedb", port_udp=50000):
        ...
        journalisation_log("MASTER", "INIT", "Initialisation des configurations...")
